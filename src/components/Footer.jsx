        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-3">
            <a href={`https://${data?.github}`} target="_blank" rel="noopener noreferrer"
               className="w-9 h-9 rounded-lg glass border flex items-center justify-center text-gray-500 hover:text-indigo-400 hover:border-indigo-500 transition-all duration-300"
               style={{ borderColor: 'rgba(255,255,255,0.08)' }} aria-label="GitHub">
            ...
            <a href={`https://${data?.linkedin}`} target="_blank" rel="noopener noreferrer"
               className="w-9 h-9 rounded-lg glass border flex items-center justify-center text-gray-500 hover:text-indigo-400 hover:border-indigo-500 transition-all duration-300"
               style={{ borderColor: 'rgba(255,255,255,0.08)' }} aria-label="LinkedIn">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
